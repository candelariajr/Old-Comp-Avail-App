...
<div id="main">
		...
		<div id="computer_map_<?php echo $floor_name; ?>_600">
			...
			<dl>
				...
				for ($i = 0; $i < mysql_num_rows($result_floor) ; $i++) {
					...
					if ($row['is_offline']==0) {
						if ($row['is_pilot']==1) {
							echo "<span class=\"hotspot\" onmouseover=\"tooltip.show('" . $row['computer_name'] . "');\" onmouseout=\"tooltip.hide();\"><dt class=\"pilot_600 mapicon\" style=\"left: " . ($row['left_pos']*2) . "px;top:" . $row['top_pos']*2 . "px\">" . $row['computer_name'] . "</dt></span>";

						}
						elseif ($row['is_dedicated']==1) {
							echo "<span class=\"hotspot\" onmouseover=\"tooltip.show('" . $row['computer_name'] . "');\" onmouseout=\"tooltip.hide();\"><dt class=\"microfilm_600 mapicon\" style=\"left: " . ($row['left_pos']*2) . "px;top:" . $row['top_pos']*2 . "px\">" . $row['computer_name'] . "</dt></span>";
						}
						else {
							echo "<span class=\"hotspot\" onmouseover=\"tooltip.show('" . $row['computer_name'] . "');\" onmouseout=\"tooltip.hide();\"><dt class=\"" . ($row['status']==0 ? 'avail' : 			 	 'busy') . "_" . (strcmp($row['computer_type'],'PC')==0 ? 'pc' : 'mac'). ($row['is_public']==1 ? '_public_' : '_'). "600 mapicon\" style=\"left: " . ($row['left_pos']*2) . "px;top:" . $row['top_pos']*2 . "px\">" . $row['computer_name'] . "</dt></span>";
						...
						echo "<span class=\"hotspot\" onmouseover=\"tooltip.show('" . $row['computer_name'] . "');\" onmouseout=\"tooltip.hide();\"><dt class=\"offline_600 mapicon\" style=\"left: " . ($row['left_pos']*2) . "px;top:" . $row['top_pos']*2 . "px\">" . $row['computer_name'] . "</dt></span>";
	...
	<div id="summary">
		<table>
			...
			<tr><td><a href="tooltip.php?id=0">Lower Level</a></td><td><?php echo $floor0_pc_results; ?></td><td><?php echo $floor0_mac_results; ?></td></tr>
			<tr><td><a href="tooltip.php?id=1">First Floor</a></td><td><?php echo $floor1_pc_results; ?></td><td><?php echo $floor1_mac_results; ?></td></tr>
			<tr><td><a href="tooltip.php?id=2">Second Floor</a></td><td><?php echo $floor2_pc_results; ?></td><td><?php echo $floor2_mac_results; ?></td></tr>
			<tr><td><a href="tooltip.php?id=3">Third Floor</a></td><td><?php echo $floor3_pc_results; ?></td><td><?php echo $floor3_mac_results; ?></td></tr>
